...
async function main() {
    ...
    function broadcastViewedMessage(videoId) {
        ...
        console.log(`Publishing message on "viewed" exchange for video id: SampleVideo_${videoId}.`);
        
        const msg = { videoId }; // Message payload.
    ...
    app.get("/video", async (req, res) => { // Route for streaming video.
        ...
        // select path by id
        const videoPath = `./videos/SampleVideo_${videoId}.mp4`;
